...
As **[Matteo Colina](https://nodeland.dev/)** wrote in his articles [here](https://adventures.nodeland.dev/archive/software-engineering-splits-in-three/), the industry is changing rapidly. In **Vietnamese** market, I strongly believe that the 'third path' mentioned his articles will take a majority. Like in my case above, the client have some specific requirements that no other Saas can provide. So we can ride solo, but in order to do that, we must upgrade our soft skills: sale, business analytics and business development.
